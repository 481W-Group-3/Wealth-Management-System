...
public class InvestmentServiceImpl implements InvestmentService {
	...
	public Investment addInvestment(Investment investment, String username) {
        ...
        case "Stock":
            ...
            returns = calculateStockReturns(investment.getPurchasePrice(), investment.getCurrentValue(), investment.getShares(), investment.getAnnualDividend());
            break;
        case "Bond":
            returns = calculateBondReturns(investment.getFaceValue(), investment.getCouponRate(), investment.getPricePaid(), investment.getYearsToMaturity());
            break;
        case "Mutual Fund":
            returns = calculateMutualFundReturns(investment.getStartingNAV(), investment.getEndingNAV(), investment.getDividends());
            break;
        case "Real Estate":
            returns = calculateRealEstateReturns(investment.getInitialInvestment(), investment.getNetRentalIncome(), investment.getNewPropertyValue(), investment.getOriginalPurchasePrice());
            break;
        case "Cryptocurrency":
	...
	public double calculateRealEstateReturns(double initialInvestment, double netRentalIncome, double newPropertyValue, double originalPurchasePrice) {
