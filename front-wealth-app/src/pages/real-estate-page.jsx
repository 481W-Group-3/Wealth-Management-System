                              ...
                              <td colSpan="5" className="border-b px-4 py-2">
                                ...
                                <FormsForDashboard
                                  ...
                                  formFields={[
                                    ...
                                    { name: 'paymentMonthly', label: 'Rent Monthly', type: 'number', value: newLease.paymentMonthly, onChange: (e) => setNewLease({ ...newLease, paymentMonthly: e.target.value }) },
                                    { name: 'rentDueDay', label: 'Rent Collection Day', type: 'number', value: newLease.rentDueDay, onChange: (e) => setNewLease({ ...newLease, rentDueDay: e.target.value }) }
                                  ]}
