...
const RetirementPage = () => {
  ...
  const updateBackendAndCalculator = async () => {
    ...
    if (retirementAge < currentAge) {
      ...
      alert(
        "Retirement Age or Current Age is greater than your life expectancy!"
      );
    } else {
  ...
  const calculationTotalAmount = (total) => {
    ...
    document.getElementById("retirementCalcTotalAmount").innerHTML =
      "$" + formatNumber(total);
  };
  ...
  const calculationMoneyInvested = (total) => {
    total = Math.floor(total);
    document.getElementById("retirementCalcMoneyInvested").innerHTML =
      "$" + formatNumber(total);
  };
  ...
  const calculationPercentageNeeded = (expenses, savings, time) => {
    ...
    document.getElementById("retirementCalcPercentageNeededYearly").innerHTML =
      "$" + formatNumber(totalYearly) + " (" + percentage + "%)";
    document.getElementById("retirementCalcPercentageNeededMonthly").innerHTML =
      "$" + formatNumber(totalMonthly) + " (" + percentage + "%)";
  };
        ...
        <div className="retirementTwoColumns">
          <div className="retirementLeftColumn">
            ...
            <form id="retirementCalculator">
              ...
              <button type="button" onClick={updateBackendAndCalculator}>
                Calculate Results
              </button>
            </form>
          </div>
